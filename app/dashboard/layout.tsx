    ...
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-[240px_1fr]">
      <aside className="bg-white border-b md:border-r md:border-b-0">
        ...
        <nav className="p-2 space-y-1">
          ...
          <Link className="block px-4 py-2 hover:bg-slate-100 rounded" href="/dashboard/raw-materials">Matérias-Primas</Link>
          <Link className="block px-4 py-2 hover:bg-slate-100 rounded" href="/dashboard/metrics">Acompanhamento</Link>
          <Link className="block px-4 py-2 hover:bg-slate-100 rounded" href="/dashboard/production-times">⏱️ Tempos de Produção</Link>
        </nav>
